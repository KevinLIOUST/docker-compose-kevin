...
$products = [
    [
        ...
        'prix' => 90,
        'description' =>
            'Casque audio confortable au son immersif, parfait pour la musique, le gaming ou les appels.',
        'image' => 'assets/img/casque_audio-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' => 'Télé Geek RétroPixel 80s',
        'prix' => 70,
        'description' =>
            'Télévision rétro avec écran CRT et affichage pixelisé Space Invaders : la touche nostalgie ultime pour tout geek qui se respecte !',
        'image' => 'assets/img/Télé_Geek_RétroPixel_80s-2.png',
    ],
    [
        'categorie' => 'Téléphonie',
        'nom' => 'Téléphone Geek RetroGame One',
        'prix' => 50,
        'description' =>
            'Un téléphone old-school avec jeu 8-bit intégré, antenne vintage et look pixelisé pour les vrais nostalgeeks !',
        'image' => 'assets/img/telephone_geek-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
            'Carte Graphique - ROG ASTRAL GeForce RTX 5090 - PixelCore Galaxy Edition',
        'prix' => 2349,
        'description' =>
            'Carte graphique ultra-puissante au design pixel-art rétro, parfaite pour les gamers geeks en quête de style et de performance !',
        'image' =>
            'assets/img/Carte_graphique_NVIDIA_GeForce_RTX_5090_ASUS_Rog_ASTRAL-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
        ...
        'image' =>
            'assets/img/Processeur_AMD_Ryzen_7_9800X3D_Otaku_Boost_Edition-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
        ...
        'image' =>
            'assets/img/Watercooling_MSI_MAG_Coreliquid_C360_Neo_Otaku_Edition-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
            'Carte Mère - GIGABYTE B650 Gaming X AX V2 - Neo Genesis Geek Edition',
        'prix' => 170,
        'description' =>
            'Carte mère pensée pour les fans d\'animés et de gaming rétro, la Neo Genesis Geek Edition allie compatibilité Ryzen, connectivité DDR5/Wi-Fi 6E et style otaku. Elle offre à ta config un vrai boost de personnalité pixelisée et de puissance !',
        'image' =>
            'assets/img/Carte_Mère_Gigabyte_X_AX_V2_Neo_Genesis_Geek_Edition-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
    ...
    [
        ...
        'image' =>
            'assets/img/Thermaltake_Toughpower_GT_850W_Pixel_Storm_Edition-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
        ...
        'image' =>
            'assets/img/Creative_Peebles_Pro_2-0_KameSound_Edition-2.png',
    ],
    [
        'categorie' => 'Informatique',
        'nom' =>
